    ...
    return (
        <div>
            ...
            <div className='flex items-center justify-center py-8'>
                <h2 className='uppercase font-bold text-2xl text-center'>we are weaving the future with passion</h2>
            </div>
            <div className='flex justify-center items-center relative'>
                ...
                <div className='text-center absolute'>
                    ...
                    <h5 className='text-white text-2xl max-md:text-xl'>We promote the use of <span className='font-semibold'>recycled & eco-friendly</span> raw material & yarns</h5>
